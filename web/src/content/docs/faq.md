...
**Q：一定要注册才能用吗？**
A：不需要。桌面应用全功能本地使用；文档、下载、社区匿名开放。登录仅在跨设备同步（开发中）、云平台、管理员时出现。
...
**Q：桌面应用和自托管有什么区别？**
A：桌面应用是面向个人、零部署的本地应用；自托管是自己部署云平台。两者数据模型一致，未来可互通（🚧）。

## 开发中

**Q：跨设备同步什么时候有？**
A：正在规划中（P4）。登录账户后可在多设备间同步数据。

**Q：桌面应用什么时候发布？**
A：正在开发中（P3），支持 Windows / macOS / Linux，发布后本站与 GitHub 提供下载。
